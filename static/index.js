    ...
    .addEventListener("click", function () {
        ...
        axios
            ...
            .catch(function (error) {
                ...
                document.getElementById("metadataForm").style.display = "block";
                showAlert("Metadata could not be fetched. You can still shorten the URL.", "success");
            });
    });
...
function deleteLink(shortId) {
    ...
    showConfirmationAlert("Confirmation", "Are you sure you want to delete this URL?", "Confirm", "Cancel", confirmCallback);
}
